...
const masterData = useProductStore((state) => state.masterData);
  ...
  //console.log("Image IDs:", DefaultImages.imageIds);
  // console.log("Thumbnail ID:", DefaultImages.thumbnailId);
  // console.log("Hero Image ID:", DefaultImages.heroImageId);
...
//         sku: basicInformation.sku || undefined,
...
//       formData.append(
//         "path",
//         `/uploads/products/${image.file.name}`,
//       );
...
//     console.log("Image Map", imageIdMap);

//     // =========================================================
//     // 3. Replace every frontend image id
//     // =========================================================
...
//       imageIds: DefaultImages.imageIds.map(
//         (id) => imageIdMap[id],
//       ),
...
//         thumbnailImageId:
//           updatedDefaultImages.thumbnailId,
//         heroImageId:
//           updatedDefaultImages.heroImageId,
//       },
//     );
...
const handleSave = async () => {
  try {
    ...
    const updatedVariants = ProductVariants.map((variant) => ({
      ...
      barcode: `${product.code}-${variant.barcode}`,
